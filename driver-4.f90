...
!-----|--1--------2---------3---------4---------5---------6---------7-|
       ...
       USE interpolate_mod, only: interpolate_init, interpolateD
...
!-----|--1--------2---------3---------4---------5---------6---------7-|
       ...
       REAL(KIND=8), DIMENSION(nbmois,nx,ny) :: pfGi
...
!-----|--1--------2---------3---------4---------5---------6---------7-|
       REAL(KIND=8), DIMENSION(nbmois,nlon,nlat) :: sxsnowG
...
!       4.1: Reading climatic variables (12 months climatological)
       ...
       CALL ReadVarClimato(nbmois,nlon,nlat,sxsnowG,TRIM(fclimSN),111)
...
!-----|--1---------2---------3---------4---------5---------6---------7---------8---------9---------0---------1---------2---------3-|
       ...
       do dummy=1,100
       results = interpolateD(tab_dat,the_weights,the_sum_weights,sxsnowG(:,:,:),pfGi(:,:,:),nx,ny,nw,nz,nlon,nlat,nbmois)
       enddo
